...
int main(int argc, char* argv[]) {
  ...
  // test Sum
  const double kExpected_sum = 124.3;
  ...
  // test avg
  const double kExpected_avg = 17.5714;
  ...
  // test Sort
  const std::string kExpected_doubles = "-12 -0.2 1 21.2 23.3 45 46";
