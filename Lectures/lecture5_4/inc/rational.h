...
//
#ifndef LECTURE5_4_INC_RATIONAL_H_
#define LECTURE5_4_INC_RATIONAL_H_
...
class Rational {
 public:
  ...
  //          parameter. Parameter will be changed, calling instance will not.
  //          Returns the parameter for chaining.
  std::ostream& Extract(std::ostream* out) const;


  // Insert: extracts a pair of integers separated by a slash from the
  //         parameter and stores in the calling instance, modifying both.
  //         Returns the parameter for chaining.
...
#endif  // LECTURE5_4_INC_RATIONAL_H_
